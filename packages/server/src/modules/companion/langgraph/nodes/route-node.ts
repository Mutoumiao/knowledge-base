...
const ROUTE_RULES: RouteRule[] = [
  ...
  },
  {
    ...
    shouldUsePetName: false,
    shouldMirrorEmotion: true,
    routeGuidance: '进入角色扮演：保持人设与场景一致，互动推进，不过度出戏。',
  },
  {
    when: { intent: 'preference_setting' },
    priority: 1,
    route: 'memory_ack',
    responseLength: 'short',
    shouldAskQuestion: false,
    ...
    shouldUsePetName: false,
    shouldMirrorEmotion: false,
    routeGuidance: '确认收到偏好/设置，简短回应用户期望。',
  },
  {
    when: { intent: 'date_or_activity_planning' },
    priority: 1,
    route: 'light_companion',
    responseLength: 'medium',
    shouldAskQuestion: true,
    ...
    shouldUsePetName: false,
    shouldMirrorEmotion: true,
    routeGuidance: '一起聊约会或活动计划，可给一条轻建议并确认偏好。',
  },
  {
    when: { intent: 'meta_question' },
    priority: 1,
    route: 'light_companion',
    responseLength: 'short',
    shouldAskQuestion: false,
    ...
    shouldUsePetName: false,
    shouldMirrorEmotion: false,
    routeGuidance: '用轻松、透明的方式回答关于自身能力或设定的问题。',
  },
